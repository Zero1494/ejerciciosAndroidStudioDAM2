...
//            }
            ...
            itemView.setOnClickListener {
                if (pos == seleccionado){
                    ...
                    seleccionado = pos
                    Log.e("ACSC0", "Seleccionado: ${Almacen.personajes.get(seleccionado).toString()}")
                }
...
//                context.startActivity(intent)
                ...
                Toast.makeText(context, "Valor seleccionado " +  seleccionado.toString(), Toast.LENGTH_SHORT).show()
